...
<head>
    ...
    <title>Admin Sign In - UNITED SENIORS VELLANAD</title>
    @include('pwa')
    ...
    <style>
        ...
        .form-card::before {
            ...
            right: 0;
            height: 4px;
            background: linear-gradient(90deg, var(--primary-color), #ff9800, var(--text-color));
        }
...
<body>
    ...
    <header class="header">
        ...
        <nav class="nav-menu">
            ...
            <a href="https://cricheroes.com" class="nav-link" target="_blank" rel="noopener">MATCHES</a>
    ...
    <main class="main-content">
        <div class="form-card">
            ...
            <div class="form-subtitle">Enter Administrator Credentials to Access Control Panel</div>
            ...
            <form action="{{ route('login.admin.post') }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="username" name="username" class="form-input" placeholder="Enter Username (Admin)" required value="{{ old('username') }}" autofocus autocomplete="username">
                </div>
                ...
                <button type="submit" class="submit-btn">Log In as Admin</button>
            </form>
